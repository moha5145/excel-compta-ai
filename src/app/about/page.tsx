    ...
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden flex flex-col">
      ...
      <header className="border-b border-border/40 bg-background/60 backdrop-blur-2xl sticky top-0 z-50">
        <div className="flex items-center justify-between px-6 py-4 max-w-4xl mx-auto w-full">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-lg font-display text-foreground tracking-tight">
              Excel-Formule <span className="text-primary font-sans font-medium">AI</span>
            </h1>
          </div>
          <Link
            href="/"
            className="flex items-center gap-2 text-xs font-medium text-muted-foreground hover:text-foreground transition-all bg-muted hover:bg-muted/80 border border-border rounded-xl px-4 py-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-6 py-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          <div className="bg-card/40 backdrop-blur-xl border border-border rounded-2xl p-6 flex flex-col gap-4">
          ...
          <div className="bg-card/40 backdrop-blur-xl border border-border rounded-2xl p-6 flex flex-col gap-4">
            ...
            <h3 className="text-foreground font-semibold text-base">Stateless</h3>
            <p className="text-muted-foreground text-xs leading-relaxed">
          ...
          <div className="bg-card/40 backdrop-blur-xl border border-border rounded-2xl p-6 flex flex-col gap-4">
            <div className="w-10 h-10 rounded-xl bg-green-500/10 border border-green-500/20 flex items-center justify-center text-green-500 dark:text-green-400">
              <RefreshCw size={20} />
            </div>
            <h3 className="text-foreground font-semibold text-base">Contrôle total</h3>
            <p className="text-muted-foreground text-xs leading-relaxed">
        ...
        {/* FAQ Section */}
        <section className="bg-card/20 backdrop-blur-xl border border-border/80 rounded-3xl p-8 mb-12">
          <h3 className="text-foreground font-display text-2xl mb-8 flex items-center gap-2">
          ...
          <div className="space-y-6">
            ...
            <div className="border-b border-border/60 pb-6">
              <h4 className="text-foreground font-medium text-base mb-2">Où puis-je obtenir une clé API Gemini gratuite ?</h4>
              <p className="text-muted-foreground text-sm leading-relaxed">
        ...
        {/* GDPR statement */}
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 p-6 rounded-2xl bg-muted/40 border border-border text-xs text-muted-foreground">
          <span>
            © {new Date().getFullYear()} Excel-Formule AI. Conforme au RGPD. Hébergement sécurisé en Europe.
          </span>
          <div className="flex gap-4">
            <a href="https://aistudio.google.com/support" target="_blank" rel="noreferrer" className="hover:text-foreground transition-colors">Support Google AI Studio</a>
            <Link href="/" className="hover:text-foreground transition-colors">Retour à l&apos;assistant</Link>
          </div>
        </div>
      </main>
    </div>
