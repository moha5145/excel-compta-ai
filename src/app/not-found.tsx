...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden flex flex-col items-center justify-center p-6">
      ...
      <div className="relative z-10 text-center max-w-md w-full bg-card/40 backdrop-blur-xl border border-border rounded-3xl p-8 shadow-2xl flex flex-col items-center gap-6">
        ...
        <div className="space-y-2">
          <h2 className="text-4xl font-display text-foreground">404</h2>
          <h3 className="text-lg font-semibold text-foreground">Formule introuvable</h3>
