...
export default function Error({ error, reset, unstable_retry }: ErrorProps) {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden flex flex-col items-center justify-center p-6">
      ...
      <div className="relative z-10 text-center max-w-md w-full bg-card/40 backdrop-blur-xl border border-border rounded-3xl p-8 shadow-2xl flex flex-col items-center gap-6 animate-in fade-in zoom-in-95 duration-300">
        ...
        <div className="space-y-2">
          <h2 className="text-4xl font-display text-foreground">Erreur</h2>
          <h3 className="text-lg font-semibold text-foreground">Une anomalie est survenue</h3>
          ...
          <div className="mt-4 bg-muted/60 border border-border rounded-xl p-3.5 text-left max-h-36 overflow-y-auto w-full">
            <p className="text-[10px] uppercase tracking-wider text-muted-foreground font-semibold mb-1">
              Détails techniques :
            </p>
            <code className="text-xs text-red-500 dark:text-red-400 font-mono break-all whitespace-pre-wrap">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full">
          ...
          <Link
            href="/"
            className="flex-1 flex items-center justify-center gap-2 text-sm font-medium text-foreground bg-muted hover:bg-muted/80 border border-border rounded-xl py-3.5 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background"
